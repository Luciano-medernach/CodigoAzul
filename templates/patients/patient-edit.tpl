...
<body class="bg-gradient-to-b from-cwhite to-clightblue  min-h-screen text-cdarkblue pb-20">
    ...
    <form class="text-base box-with-shadow w-full max-w-2xl mx-auto p-4 mt-6 "  action="db-patient-edit" method="POST">
        <div class="grid grid-cols-2 gap-2 justify-items-center  pb-2">
            ...
            <input class=" w-full text-cdarkgray pl-2 bg-clightblue  h-8 inputs-form" type="text" name="family_phone" placeholder="Telefono " maxlength="15" value="{$patient->family_phone}"/>
            <input class=" w-full text-cdarkgray pl-2 bg-clightblue  h-8 inputs-form" type="number" name="height" placeholder="Altura" step="0.01" max="4" value="{$patient->height}"/>
            ...
            <input class=" w-full text-cdarkgray pl-2 bg-clightblue  h-10 inputs-form" type="number" name="weight" placeholder="Peso" step="0.1" max="500" value="{$patient->weight}" />

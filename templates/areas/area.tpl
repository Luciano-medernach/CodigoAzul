...
<body class="bg-gradient-to-b from-cwhite to-clightblue  min-h-screen text-cdarkblue pb-20">
   ...
   <div class=" mx-auto grid grid-cols-2 items-center ">     
    ...
    <div class="box-with-shadow w-xl mx-auto bg-clightgreen/50 "> 
            {if $admin}
                <form class=" box-with-shadow w-80 mx-auto items-center" action="db-area-assign-patient " method="POST">
